...
namespace LimbusCompanyBusRUS
{
    internal class LCBR_TemporaryTextures
    {
        ...
        private static void Drive_Init(StageUIPresenter __instance)
        {
            ...
            if (rd_glow1 != null)
                rd_glow1.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[3];
            if (rd_glow2 != null)
                rd_glow2.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[2];
            ...
            if (md_glow1 != null)
                md_glow1.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[3];
            if (md_glow2 != null)
                md_glow2.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[2];
            ...
            if (rr_glow1 != null)
                rr_glow1.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[3];
            if (rr_glow2 != null)
                rr_glow2.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[2];
            ...
            if (event_glow != null)
                event_glow.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[3];
        }
        [HarmonyPatch(typeof(GachaUIPanel), nameof(GachaUIPanel.Initialize))]
        [HarmonyPostfix]
        private static void Gacha_Init(GachaUIPanel __instance)
        {
            __instance.tmp_alreadyUsedGacha.fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[6];
        }
        #endregion
        ...
        private static void Lobby_Init(LobbyUIPresenter __instance)
        {
            ...
            if (lobby_glow != null)
                lobby_glow.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[5];
        }
        ...
        private static void Story_Init (StoryUIPanel __instance)
        {
            ...
            if (dialogue_glow != null)
                dialogue_glow.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[5];
        }
        ...
        private static void EGO_Init(BattleSkillViewUIController __instance)
        {
            ...
            if (ego_glow != null)
                ego_glow.GetComponentInChildren<TextMeshProUGUI>(true).fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[5];
        }
        ...
        {
            __instance.tmp_dialog.fontMaterial = LCB_Cyrillic_Font.tmpcyrillicmats[5];
        }
        #endregion
    }
}
